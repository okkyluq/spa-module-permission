                ...
                <div class="block-header block-header-default">
                    ...
                    <div class="block-options">
                        <button type="button" class="btn btn-success" v-if="checkAcces('import_import_mygrapari')"
                            @click="$store.dispatch('ImportmygrapariStoreImport/toggleSidebar', true)"
...
export default {
    ...
    computed:{
        ...mapState('ImportmygrapariStoreIndex', {
            list_importmygrapari: state => state.list_importmygrapari
        })
    },
    methods: {
        ...mapActions('ImportmygrapariStoreIndex', {
