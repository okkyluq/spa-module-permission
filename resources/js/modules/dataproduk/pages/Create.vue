				...
				<div class="col-sm-12">
                    ...
                    <div class="row mb-2">
						<div class="col-sm-6 offset-sm-3">
                            <button @click="$store.dispatch('DataprodukStoreAdd/toggleSidebar', false)" type="button" class="btn btn-danger">Batal</button>
...
export default {
    ...
    computed: {
        ...mapState('DataprodukStoreAdd', {
            form: state => state.form,
            visible_sidebar: state => state.visible_sidebar
        })
    },
    methods: {
        ...mapActions('DataprodukStoreAdd', {
            clearForm: 'clearForm',
			...
			Axios.post('dataproduk', formData)
				.then(response => {
                    if(response.status === 200){
                        this.$store.dispatch('DataprodukStoreAdd/toggleSidebar', false);
                        this.$store.dispatch('DataprodukStoreIndex/getListProduk');
                    }
				})
				.catch(error => {
