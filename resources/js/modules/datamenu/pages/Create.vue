				...
				<div class="col-sm-12">
                    ...
                    <div class="row mb-2">
						<div class="col-sm-12 text-end">
                            <button @click="$store.dispatch('DatamenuStoreAdd/toggleSidebar', false)" type="button" class="btn btn-danger">Batal</button>
...
import SelectG from '../../../partials/SelectG.vue'
...
export default {
    ...
    computed: {
        ...mapState('DatamenuStoreAdd', {
            form: state => state.form,
            visible_sidebar: state => state.visible_sidebar
        })
    },
    methods: {
        ...mapActions('DatamenuStoreAdd', {
            clearForm: 'clearForm',
			...
			Axios.post('datamenu', formData)
				.then(response => {
                    if(response.status === 200){
                        this.$store.dispatch('DatamenuStoreAdd/toggleSidebar', false);
