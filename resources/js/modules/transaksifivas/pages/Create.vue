				...
				<div class="col-sm-12">
                    ...
                    <div class="row mb-2">
						<div class="col-sm-12 text-end">
                            <button @click="$store.dispatch('TransaksifivasStoreAdd/toggleSidebar', false)" type="button" class="btn btn-danger">Batal</button>
...
export default {
    ...
    computed: {
        ...mapState('TransaksifivasStoreAdd', {
            form: state => state.form,
            visible_sidebar: state => state.visible_sidebar
        })
    },
    methods: {
        ...mapActions('TransaksifivasStoreAdd', {
            clearForm: 'clearForm',
			...
			Axios.post('transaksifivas', formData)
				.then(response => {
                    if(response.status === 200){
                        self.$store.dispatch('TransaksifivasStoreAdd/toggleSidebar', false);
